...
describe('Custom Tests', function () {
  ...
  it('[assignment] ii. deposit 0.1 ETH in L1 -> withdraw 0.08 ETH in L2 -> assert balances', async () => {
    ...
    const tornadoRemainingAmount = utils.parseEther('0.02')
    ...
    expect(tornadoPoolBalance).to.be.equal(tornadoRemainingAmount);
  ...
  it('[assignment] iii. see assignment doc for details', async () => {
    ...
    await omniBridge.execute([
      ...
      // Alice withdraws the rest of the amount from L1
    const recipient2 = '0xDeaD00000000000000000000000000000000BEEf'
